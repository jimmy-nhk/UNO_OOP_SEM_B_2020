...
public class SoundController {
    ...
    private static Sound backgroundMusic = new Sound("src/resources/sounds/ticktockSound.mp3");
    //Button sound object, for making sound when pressing the sound enabled button
    private static Sound buttonClickingSound = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound cardDealingSound = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound cardShuffleSound = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound cardAppearSound = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound alarmSoundEffect = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound ticktockSoundEffect = new Sound("src/resources/sounds/ticktockSound.mp3");
    private static Sound startGameSound = new Sound("src/resources/sounds/sound_launch.mp3");
