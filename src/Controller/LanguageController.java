...
public class LanguageController {
    ...
    // setup button text
    public static void setUpCheckBoxText(CheckBox checkBox, final String key, final Object... args) {
        checkBox.textProperty().bind(createStringBinding(key));
    }

    // setup button text
    public static void setUpRadioButtonText(RadioButton radioButton, final String key, final Object... args) {
        radioButton.textProperty().bind(createStringBinding(key));
    }
