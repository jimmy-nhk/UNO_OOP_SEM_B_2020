...
//    }
    ...
    /**
     * draw more than 1 to bot's deck
     */
    ...
    public void turn(Card lastCard, Color wishColor, boolean challenge) {
        ...
        if (validDeck.size() == 0) {
            if (challenge) {
                ...
                System.out.println("deck after drawing: " + deck);
            } else {
            ...
            System.out.println("AI chose: " + getHighestValuedCard(validDeck));
