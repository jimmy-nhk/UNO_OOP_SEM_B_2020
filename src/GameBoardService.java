...
public class GameBoardService {
    private static GameBoardService INSTANCE = new GameBoardService();
...
//    }
    ...
    public void plusFour() {
        for (int i = 0; i < 4; i++) {
            inGamePlayers.get(positionOfCurrentPlayer + directionOfPlay).drawCard(deck.drawTopCard());
        }
        updateTurn();
    }
