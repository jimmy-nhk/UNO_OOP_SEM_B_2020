...
public class MainController {
    public ClientController client = new ClientController("2.tcp.ngrok.io", 15970);
    ...
    public void showSetNameScene (){
        ...
        buttonSetName.setOnAction(e -> {
            ...
            try
            {
                ...
                Message message = new Message(namesList,winList);
//                Message message = new Message(fos);
    ...
    public static void processMessage(Message message) {
        //Verify list data
        for (String name : message.getPlayerName()) {
            System.out.println(name);
        }
        for (int name : message.getWin()) {
            System.out.println(name);
        }
    }
}
